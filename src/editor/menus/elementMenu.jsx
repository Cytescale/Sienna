     ...
     export const MenuButtonInd = [
          ...
          {    id:"header-one",
               element:<div>
          <div className="element_adder_menu_butt_pri_tit">
          <svg className="element_adder_menu_butt_ico" height="24px" viewBox="0 0 24 24" width="24px" fill="currentColor"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 4v3h5.5v12h3V7H19V4H5z"/></svg>
          Header 1
          </div>
          <div className="element_adder_menu_butt_sec_tit">
          ...
          {    id:"quote",
               element:<div>
          <div className="element_adder_menu_butt_pri_tit">
          <svg className="element_adder_menu_butt_ico" height="24px" viewBox="0 0 24 24" width="24px" fill="currentColor"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M7.17 17c.51 0 .98-.29 1.2-.74l1.42-2.84c.14-.28.21-.58.21-.89V8c0-.55-.45-1-1-1H5c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1h2l-1.03 2.06c-.45.89.2 1.94 1.2 1.94zm10 0c.51 0 .98-.29 1.2-.74l1.42-2.84c.14-.28.21-.58.21-.89V8c0-.55-.45-1-1-1h-4c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1h2l-1.03 2.06c-.45.89.2 1.94 1.2 1.94z"/></svg>
          Quote
          </div>
          <div className="element_adder_menu_butt_sec_tit">
          ...
          </div>},
          {
               ...
               element:<div>
          <div className="element_adder_menu_butt_pri_tit"> 
          <svg className="element_adder_menu_butt_ico" height="24px" viewBox="0 0 24 24" width="24px" fill="currentColor"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M4 10.5c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5-.67-1.5-1.5-1.5zm0-6c-.83 0-1.5.67-1.5 1.5S3.17 7.5 4 7.5 5.5 6.83 5.5 6 4.83 4.5 4 4.5zm0 12c-.83 0-1.5.68-1.5 1.5s.68 1.5 1.5 1.5 1.5-.68 1.5-1.5-.67-1.5-1.5-1.5zM8 19h12c.55 0 1-.45 1-1s-.45-1-1-1H8c-.55 0-1 .45-1 1s.45 1 1 1zm0-6h12c.55 0 1-.45 1-1s-.45-1-1-1H8c-.55 0-1 .45-1 1s.45 1 1 1zM7 6c0 .55.45 1 1 1h12c.55 0 1-.45 1-1s-.45-1-1-1H8c-.55 0-1 .45-1 1z"/></svg>
          Bullet List
          </div>
          <div className="element_adder_menu_butt_sec_tit">
          ...
          </div>},
          {
               ...
               element:<div>
          <div className="element_adder_menu_butt_pri_tit">
          <svg  className="element_adder_menu_butt_ico" viewBox="0 0 512 512"><title>Git Commit</title><circle cx="256" cy="256" r="96" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M160 256H48M464 256H352"/></svg>
          Divider
          </div>
          <div className="element_adder_menu_butt_sec_tit">
     ...
     const ElementAdderMenu = (props)=>{
          ...
          const [selectedButtonInd,setselectedButtonInd] = useState(props.editorAdderMenuObject.adderInd);
          ...
          useEffect(()=>{
               if(props.visi && !entry_anim){        
                    ...
                    if(!DOMRect){return;}
                    let init_spawn_x = selecDomRect?selecDomRect.x!==0?selecDomRect.x:DOMRect.x:DOMRect.x;
                    let inti_spawn_y = selecDomRect?selecDomRect.y!==0?selecDomRect.y:DOMRect.y:DOMRect.y;
                    let offset_x = 0;
                    let offset_y = 0;
