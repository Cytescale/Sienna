...
function BlockWrapper(props) {
  ...
  const editor_unlocked =
    props.blockProps.lockState === EditorLockState.UNLOCKED ?? true;
  if (visi && !entry_anim) {
    setentry_anim(true);
    setcurrVisi(true);
      ...
      >
        <div
          className={`sienna-editor-block-wrapper-butt-cont 
                        ${
                          entry_anim
                            ? "sienna-editor-block-wrapper-butt-cont_enter"
                            : null
                        } 
                        ${
                          exit_anim
                            ? "sienna-editor-block-wrapper-butt-cont_exist"
                            : null
                        }
             `}
          onAnimationEnd={() => {
        ...
        >
          <button
            ...
            onClick={(e) => {
              ...
              const chngeSelec = SelectionState.createEmpty(
                props.block.getKey()
              );
